const handler = async (m, { conn }) => {
  ...
  conn.sendMessage(m.chat, { 
    ...
    quoted: {
      ...
      message: {
        locationMessage: {
          name: "𝑪𝒂𝒕𝒆𝒈𝒐𝒓𝒊𝒂 𝒄𝒐𝒍𝒍𝒂𝒃𝒐𝒓𝒂𝒕𝒐𝒓𝒊 🤝🏼",  // Nome del messaggio in miniatura
...
handler.command = /^(listacollaboratori|listacollaboratore)$/i;
