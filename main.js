...
mobile: MethodMobile, 
browser: opcion == '1' ? ['ᴼʳⁱᵍⁱⁿ ᴮᵒᵗ✦', 'Safari', '2.0.0'] : methodCodeQR ? ['ᴼʳⁱᵍⁱⁿ ᴮᵒᵗ✦', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `ᴼʳⁱᵍⁱⁿ ᴮᵒᵗ✦ 𝐨𝐧𝐥𝐢𝐧𝐞 𝐝𝐚 ${uptime} `
